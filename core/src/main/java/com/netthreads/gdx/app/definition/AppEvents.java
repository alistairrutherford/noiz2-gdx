...
public class AppEvents
{
	...
	public static final int EVENT_PLAY_ZAP = EVENT_BASE + 6;
	public static final int EVENT_PLAY_EXPLOSION_A = EVENT_BASE + 7;
	public static final int EVENT_PLAY_EXPLOSION_B = EVENT_BASE + 8;
